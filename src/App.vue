...
<template>
  <div class="min-h-screen flex flex-col relative bg-gray-50 dark:bg-gray-900 font-sans text-gray-800 dark:text-gray-200">
    ...
    <main class="flex-grow container mx-auto p-6 flex flex-col items-center justify-center relative z-10">
      <RouterView />
    </main>
...
.layer-1 {
  ...
  animation: move-waves 20s linear infinite;
}
